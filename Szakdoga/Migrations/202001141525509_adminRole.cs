    ...
    public partial class adminRole : DbMigration
    {
        public override void Up()
        {
            Sql("INSERT INTO [dbo].[AspNetUsers] ([Id], [Email], [EmailConfirmed], [PasswordHash], [SecurityStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled]," +
                " [LockoutEndDateUtc], [LockoutEnabled], [AccessFailedCount], [UserName], [BirthDate], [Ertekeles]) VALUES (N'2757fbbb-6528-4220-b827-6362e8363603', N'admin@gmail.com'," +
            ...
            Sql("INSERT INTO [dbo].[AspNetUsers] ([Id], [Email], [EmailConfirmed], [PasswordHash], [SecurityStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEndDateUtc]," +
                " [LockoutEnabled], [AccessFailedCount], [UserName], [BirthDate], [Ertekeles]) VALUES (N'cc5d7a79-4e4c-40a8-a626-462ea8667e97', N'user@gmail.com', 0, N'APA+nBGCuLDtBEWVMQYxBtwqkzj9OnR2wTf2KyHfY9R+iPWfMKPtvHnX+BmK3tCV9g=='," +
                " N'd99eef32-0301-417e-a5ad-e893a50a2319', NULL, 0, 0, NULL, 1, 0, N'Kis Józsika', N'1980-03-11 00:00:00', 0)");
